...
- 버전: `v1.0.13`
- 펌웨어: `release/SDP_ClockWeather_v1.0.13.bin`
- 파일시스템: `release/littlefs-clock-weather-v1.0.13.bin`
...
- 항공기 레이더. 장치가 직접 ADS-B를 받아 안테나가 도는 PPI 화면으로 그립니다. 항공사명(125곳)과 출발-도착지(공항 210곳)가 한글로 붙고, 회전익은 기종 이름으로 따로 표시합니다. 화면의 위쪽을 실제 앉은 방향으로 돌려 놓을 수 있고, 자주 쓰는 위치는 이름을 붙여 저장해 두었다가 불러옵니다
